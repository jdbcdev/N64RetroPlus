...
import es.jdbc.n64retroplus.MenuListView;
import es.jdbc.n64retroplus.cheat.CheatUtils.Cheat;
import es.jdbc.n64retroplus.compat.AppCompatListActivity;
import es.jdbc.n64retroplus.dialog.EditCheatAdvancedDialog;
import es.jdbc.n64retroplus.dialog.EditCheatAdvancedDialog.OnAdvancedEditCompleteListener;
import es.jdbc.n64retroplus.dialog.EditCheatDialog;
import es.jdbc.n64retroplus.dialog.EditCheatDialog.OnEditCompleteListener;
import es.jdbc.n64retroplus.dialog.MenuDialogFragment;
import es.jdbc.n64retroplus.dialog.MenuDialogFragment.OnDialogMenuItemSelectedListener;
import es.jdbc.n64retroplus.persistent.AppData;
import es.jdbc.n64retroplus.persistent.GlobalPrefs;
import es.jdbc.n64retroplus.task.ExtractCheatsTask;
import es.jdbc.n64retroplus.task.ExtractCheatsTask.ExtractCheatListener;
